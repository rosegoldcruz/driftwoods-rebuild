          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white font-semibold text-lg px-8 py-4 rounded-xl transition-all min-h-[56px] min-w-[180px] active:scale-[0.98] shadow-lg shadow-primary/30 border-2 border-primary lg:hover:shadow-[0_0_24px_rgba(224,122,47,0.45)] order-cta-pulse"
